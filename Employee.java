...
public class Employee {
	...
	//5. Método toString. Es un "Override" que se refiere a la capacidad de proporcionar información específica de una clase en forma de cadena de carácteres. Nos permite imprimir nuestros objetos en formato String.
